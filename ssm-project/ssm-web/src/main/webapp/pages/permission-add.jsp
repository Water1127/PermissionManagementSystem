			...
			<form action="${pageContext.request.contextPath}/permission/save.do"
				...
				<div class="panel panel-default">
					...
					<div class="row data-type">
						<div class="col-md-1 title">权限ID</div>
						<div class="col-md-3 data">
							<input type="text" class="form-control" name="id" placeholder="权限ID" value="">
						</div>
						<div class="col-md-1 title">权限名称</div>
						<div class="col-md-3 data">
							<input type="text" class="form-control" name="permissionName" placeholder="权限名称" value="">
						</div>
						<div class="col-md-1 title">RUL</div>
						<div class="col-md-3 data">

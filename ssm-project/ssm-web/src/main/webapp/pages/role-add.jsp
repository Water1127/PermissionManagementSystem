				...
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="id" placeholder="角色ID" value="">
						</div>
						<div class="col-md-2 title">角色名称</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="roleName" placeholder="角色名称" value="">
						</div>
						<div class="col-md-2 title  rowHeight2x">角色描述</div>
						<div class="col-md-10 data  rowHeight2x">
							<textarea type="text" class="form-control" rows="3" name="roleDesc" placeholder="角色描述" value=""></textarea>
						</div>
					</div>
				</div>
				<!--订单信息/--> <!--工具栏-->

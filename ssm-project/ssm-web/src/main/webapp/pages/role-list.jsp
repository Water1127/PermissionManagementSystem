	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li><a href="${pageContext.request.contextPath}/role/findAllByPage.do">角色管理</a></li>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="table-box">
                        ...
                        <!--主体：数据列表-->
                        <form id="form" action="${pageContext.request.contextPath}/role/deleteRoleListById.do" method="post">
                                ...
                                <c:forEach items="${pageInfo.list}" var="role">
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="javascript:deleteOne(${role.id});" class="btn bg-olive btn-xs">删除角色</a>
				...
				<div class="box-footer">
					...
					<div class="box-tools pull-right">
						<ul class="pagination">
							<%-- 首页 --%>
							<li><a href="${pageContext.request.contextPath}/role/findAllByPage.do?pageNum=1&pageSize=${pageInfo.pageSize}" aria-label="Previous">首页</a></li>
							<%-- 上一页 --%>
							<li><a href="${pageContext.request.contextPath}/role/findAllByPage.do?pageNum=${pageInfo.pageNum-1}&pageSize=${pageInfo.pageSize}">上一页</a></li>
							<%-- 页码 --%>
							<c:forEach begin="1" end="${pageInfo.pages}" var="number">
								<li><a href="${pageContext.request.contextPath}/role/findAllByPage.do?pageNum=${number}&pageSize=${pageInfo.pageSize}">${number}</a></li>
							</c:forEach>
							<%-- 下一页 --%>
							<li><a href="${pageContext.request.contextPath}/role/findAllByPage.do?pageNum=${pageInfo.pageNum+1}&pageSize=${pageInfo.pageSize}">下一页</a></li>
							<%-- 尾页 --%>
							<li><a href="${pageContext.request.contextPath}/role/findAllByPage.do?pageNum=${pageInfo.lastPage}&pageSize=${pageInfo.pageSize}" aria-label="Next">尾页</a></li>
						</ul>
					</div>
				</div>
            </div>
		...
		<script>
			...
			function deleteOne (id) {
				if (confirm("您确定要删除吗？")){
					location.href="${pageContext.request.contextPath}/role/deleteRoleById.do?id="+id;
				}
            }
			...
			function changePageSize() {
				...
				//向服务器发送请求，改变没页显示条数
				location.href = "${pageContext.request.contextPath}/role/findAllByPage.do?pageNum=1&pageSize="
						+ pageSize;
			}
